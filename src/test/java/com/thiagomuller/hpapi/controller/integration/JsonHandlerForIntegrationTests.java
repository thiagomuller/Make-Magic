...
public class JsonHandlerForIntegrationTests {
	public static String createCharacterJsonForPosting(String name, String role, String school, String houseId, String patronus, String bloodStatus) throws JSONException{
	...
	public static String createCharacterJsonForUpdateOrExpectedResponse(Integer characterId, String name, String role, String school, String houseId, String patronus, String bloodStatus) 
